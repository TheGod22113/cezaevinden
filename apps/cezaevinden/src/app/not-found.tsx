  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="text-8xl font-black text-navy-700 dark:text-blue-400 opacity-10 dark:opacity-20 mb-4">404</div>
        <div className="text-5xl mb-4">🔒</div>
        <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">Sayfa Bulunamadı</h1>
