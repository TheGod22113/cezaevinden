        ...
        <div className="max-w-3xl">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Bu haklarınızı kullanmak için lütfen <Link href="/bize-ulasin" className="text-[#FF6000] font-semibold hover:text-[#cc4e00]">bizimle iletişime geçin</Link>.
              </p>
            </section>
            ...
            <section className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
              ...
              <p className="text-gray-700">
                Kişisel verilerinizin işlenmesi veya gizliliğiniz hakkında sorularınız varsa lütfen <Link href="/bize-ulasin" className="text-[#FF6000] font-semibold hover:text-[#cc4e00]">bizimle iletişime geçin</Link>.
              </p>
            </section>
