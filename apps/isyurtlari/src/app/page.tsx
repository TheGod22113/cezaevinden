    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-blue-600">İsyurtları Ürünleri</h1>
          <p className="text-gray-600 mt-2">Adalet Bakanlığı İsyurtları tarafından üretilen kaliteli ürünler</p>
        </div>
      </div>
